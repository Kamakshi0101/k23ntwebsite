...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO podcast_schedules (host_name, schedule_date, schedule_time, description) 
              VALUES ('$host_name', '$date', '$time', '$description')";
                ...
                <div class="overflow-x-auto">
                    <table class="w-full border-collapse">
                        ...
                        <tbody id="scheduleTable" class="bg-[#1E1E2E]">
                            <?php
                            $query = "SELECT * FROM podcast_schedules ORDER BY schedule_date, schedule_time";
